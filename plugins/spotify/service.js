...
//			if (typeof config.spotify != 'undefined' && config.spotify.length) {
                spotify = new SpotifyWebApi({
                    clientId : config.spotify.id,//'bd604371889f45739b2f684663c6eca1',
                    clientSecret : config.spotify.secret,//'efb611a216f842919dbf1767be1c2f08',
                    redirectUri : config.spotify.redirect//'http://localhost:8080',
                });
//			}
		}
