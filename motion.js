...
if (
	...
	console.log(
		"!E:",
		"Configuration Error! See: https://docs.smart-mirror.io/docs/configure_the_mirror.html#motion"
	)
}

if (
	config.motion.enabled == "pin" &&
	require.resolve("johnny-five").length > 0 &&
	require.resolve("raspi-io").length > 0
) {
	...
	console.error(
		"!E:",
		"Motion Dependencies are missing! Therefore despite my best efforts I'll have to disable motion, Dave. This is most embarrassing for us both."
	)
